...
public class SwitchClient2 extends Thread {
	...
	SwitchClient2(Socket sock,Vector<String> ips_connected_to,Vector<String> macs_connected_to,Vector<String> hash_macs_connected_to,HashMap<String,String> ip_mac,HashMap<String,String> ip_location){
		socket=sock;
		this.ips_connected_to=ips_connected_to;
		this.macs_connected_to=macs_connected_to;
		this.hash_macs_connected_to=hash_macs_connected_to;
		this.ip_mac=ip_mac;
    ...
    public void run(){
        ...
        while ((fromUser = stdIn.readLine()) != null) {
                ...
                if (fromUser.equals("Bye")) {
                    ...
                    if(ip_switch.equals(getIPAddressPrintable(getIPAddress(socket.getInetAddress())))){
                        if(command_type.equals("Join")){
